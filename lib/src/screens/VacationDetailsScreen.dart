...
class VacationDetailsScreen extends StatefulWidget {
  ...
  VacationDetailsScreen({this.id, this.requestType, this.taskOrRequest});
  @override
  createState() => VacationDetailesView();
}

class VacationDetailesView extends StateMVC<VacationDetailsScreen> {
                            ...
                            child: ListTile(
                              ...
                              subtitle: Container(
                                  child: new Text(_myRequestController
                                          ...
                                          null
                                      ? "0.0"
                                      : "${_myRequestController.requestDetails["details"]["numberOfDays"]}")),
                            )),
                      ),
                      Card(
                        elevation: 2,
                            ...
                            child: ListTile(
                              ...
                              subtitle: Container(
                                  child: new Text(_myRequestController
                                          ...
                                          null
                                      ? ""
                                      : "${_myRequestController.requestDetails["details"]["startDate"]}")),
                            )),
                      ),
                      Card(
                        elevation: 2,
                            ...
                            child: ListTile(
                              ...
                              subtitle: Container(
                                  child: new Text(_myRequestController
                                          ...
                                          null
                                      ? ""
                                      : "${_myRequestController.requestDetails["details"]["endDate"]}")),
                            )),
                      ),
                      Card(
                        elevation: 2,
                            ...
                            child: ListTile(
                              ...
                              subtitle: Container(
                                  child: new Text(_myRequestController
                                          ...
                                          null
                                      ? ""
                                      : "${_myRequestController.requestDetails["details"]["returnDate"]}")),
                            )),
                      ),
                      Card(
                        elevation: 2,
