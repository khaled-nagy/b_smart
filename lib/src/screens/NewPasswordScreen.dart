...
class NewPasswordScreen extends StatefulWidget {
  final String modifyOrNew;
  final String email;
  final String otp;
  NewPasswordScreen({this.modifyOrNew, this.email, this.otp});
...
class NewPasswordView extends StateMVC<NewPasswordScreen> {
  ...
  @override
  void initState() {
    UserController.oldPassController.text = "";
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Form(
                      key: UserController.passFormKey,
                      child: Column(
                        children: <Widget>[
                          Padding(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Image.asset(
                                          "assets/imgs/002-password@3x.png",
                                          width: 20,
                                          height: 20,
                                        ),
                                      ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("تم إعادة تعيين كلمة المرور الخاصة بك",
