...
class TerminationDetailsScreen extends StatefulWidget {
  final int id;
  final String requestType;
  final String taskOrRequest;
  TerminationDetailsScreen({this.id, this.requestType, this.taskOrRequest});
  @override
  createState() => VacationDetailesView();
}

class VacationDetailesView extends StateMVC<TerminationDetailsScreen> {
                        ...
                        child: Padding(
                            ...
                            child: ListTile(
                              leading: Icon(Icons.calendar_today,
                                  color: Theme.of(context).backgroundColor,
                                  size: 30.0),
                              title: Text("_last_Working_Day".tr(),
                                  style: TextStyle(fontSize: 20.0)),
                              subtitle: Container(
                                  child: new Text(_myRequestController
                                          ...
                                          null
                                      ? ""
                                      : "${_myRequestController.requestDetails["details"]["lastWorkingDay"]}")),
                            )),
                      ),
                      Card(
                        elevation: 2,
